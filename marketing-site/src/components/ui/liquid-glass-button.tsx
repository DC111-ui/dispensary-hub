    ...
    <>
      ...
      >
        ...
        <div className="pointer-events-none absolute inset-0 overflow-hidden rounded-[inherit]">
          <div className="animate-shine-sweep absolute inset-y-0 left-0 w-1/2 bg-gradient-to-r from-transparent via-white/80 to-transparent" />
        </div>
...
>(({ children, className, variant = "default", ...props }, ref) => {
  ...
  React.useEffect(() => {
    // Touch capability can only be read client-side; this mount-only effect
    // is the standard hydration-safe pattern (start false, detect after mount).
